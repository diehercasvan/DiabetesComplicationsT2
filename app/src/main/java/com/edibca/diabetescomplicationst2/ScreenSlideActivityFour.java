 ...
 */
public class ScreenSlideActivityFour extends FragmentActivity implements IntMenuSelector {
/**
 ...
 */
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return FragmentSlidePageFour.create(position);
        }
        public ModelFragments  loadData(){
            int[] iSrcImages=new int[8];
            iSrcImages[0]=R.drawable.sec4_1_1;
            iSrcImages[1]=R.drawable.sec4_2_1;
            iSrcImages[2]=R.drawable.sec4_3_1;
            iSrcImages[3]=R.drawable.sec4_5_1;
            iSrcImages[4]=R.drawable.sec4_5_2;
            iSrcImages[5]=R.drawable.sec4_6_1;
            iSrcImages[6]=R.drawable.sec4_6_2;
            iSrcImages[7]=R.drawable.sec4_7_1;
            ...
            int [] iD_image_single=new int [2];
            iD_image_single[0]=R.drawable.sec4_9_1;
            iD_image_single[1]=R.drawable.sec4_9_2;

            ModelFragments modelFragments=new ModelFragments();
            modelFragments.setiSrcImage(iD_image_single);
            modelFragments.setsTitlePage(getResources().getStringArray(R.array.sec_4_menu));
            modelFragments.setiSrcImages(iSrcImages);
            modelFragments.setsTitleImages(getResources().getStringArray(R.array.sec_4_images));
            modelFragments.setsFileWebViews("section_4");
