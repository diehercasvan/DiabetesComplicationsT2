 ...
 */
public class FragmentSlidePageSix extends Fragment {
    ...
    public static FragmentSlidePageSix create(int pageNumber) {

        FragmentSlidePageSix fragment = new FragmentSlidePageSix();
