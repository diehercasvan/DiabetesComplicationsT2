 ...
 */
public class FragmentSlidePageFour extends Fragment {
    ...
    public static FragmentSlidePageFour create(int pageNumber) {

        FragmentSlidePageFour fragment = new FragmentSlidePageFour();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (mPageNumber) {
            ...
            case 7:
                ...
                break;
            case 8:
                rootView = (ViewGroup) inflater.inflate(General.iD_Layout[3], container, false);
