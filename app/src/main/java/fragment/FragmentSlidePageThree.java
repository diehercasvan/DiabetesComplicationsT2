 ...
 */
public class FragmentSlidePageThree extends Fragment {
    ...
    public static FragmentSlidePageThree create(int pageNumber) {

        FragmentSlidePageThree fragment = new FragmentSlidePageThree();
