 ...
 */
public class FragmentSlidePageTwo extends Fragment {
    ...
    public static FragmentSlidePageTwo create(int pageNumber) {

        FragmentSlidePageTwo fragment = new FragmentSlidePageTwo();
