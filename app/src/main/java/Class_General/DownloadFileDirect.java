...
public final class DownloadFileDirect extends AsyncTask<String,String,String> {
    ...
    protected void onPostExecute(String file_url) {
        ...
        if(bValidaDescarga && bValidaCancelar){
            ...
            alertDialog.setTitle(mainActivity.getResources().getString(R.string.app_name));
            // Setting Dialog Message
            alertDialog.setMessage(mainActivity.getResources().getString(R.string.downloadOk));
            // Setting OK Button
            alertDialog.setButton(mainActivity.getResources().getString(R.string.downloadFileAccept), new DialogInterface.OnClickListener() {
            ...
            alertDialog.setTitle(mainActivity.getResources().getString(R.string.app_name));
            // Setting Dialog Message
            alertDialog.setMessage(mainActivity.getResources().getString(R.string.downloadError));
            // Setting OK Button
            alertDialog.setButton(mainActivity.getResources().getString(R.string.downloadFileAccept), new DialogInterface.OnClickListener() {
                public void onClick(final DialogInterface dialog,final int which) {
